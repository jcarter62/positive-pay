...
def input_file_callback(*args):
    global inp_file_name
    inp_file_name = input_file.get()
    return


def output_file_callback(*args):
    global out_file_name
    out_file_name = output_file.get()
    return
...
input_file.trace_add('write', input_file_callback)
...
output_file.trace_add('write', output_file_callback)
